...
BOOST_FUSION_ADAPT_STRUCT(
    liberty::GroupStatement,
    (std::string, group_name)
    (std::string, name)
    (std::vector<liberty::AttributeStatement>, children)
)

BOOST_FUSION_ADAPT_STRUCT(
    liberty::SimpleAttribute,
    (std::string, name)
    (liberty::SimpleAttribute::Value, value)
)

BOOST_FUSION_ADAPT_STRUCT(
    liberty::ComplexAttribute,
    (std::string, name)
    (std::vector<liberty::SimpleAttribute::Value>, values)
)

BOOST_FUSION_ADAPT_STRUCT(
    liberty::DefineStatement,
    (std::string, attribute_name)
    (std::string, group_name)
    (liberty::AttributeType, attribute_type)
)
